---
layout: post
title: "CTFZone 2018 Quals — Mobile Bank"
date: 2026-04-20
categories: [pwn, ctf]
tags: [arm, libc-leak, got-overwrite]
---
...
![checksec.png]({{ site.baseurl }}/assets/ctfzone18-mobile-bank/checksec.png)

Since its arm binary, I will use qemu to run it, looks like that:

![menu.png]({{ site.baseurl }}/assets/ctfzone18-mobile-bank/menu.png)
...
![elf.png]({{ site.baseurl }}/assets/ctfzone18-mobile-bank/elf.png)
...
I didn't want to use that since there is stack canary, I'm not familiar with arm assembly, and jumping to `system` just seemed easier. I also believe you could somehow find that libc version, in some database, but it was pretty fun to leak it and find offset myself.
